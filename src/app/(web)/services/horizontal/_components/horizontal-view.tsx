...
export function HorizontalView() {
  ...
  const machineImages = [
    ...
    '/img/machines/horizontal/MARE-short crème__Front_JPG.jpg',
    '/img/machines/horizontal/Paris_navy_65_2.jpg',
    '/img/machines/horizontal/SKATEBOARDS-1-TIFF-1 alex_mileshin.jpg',
    '/img/machines/horizontal/manteau_2_Front.jpg',
    '/img/machines/horizontal/veste beige_-_front_Front-2.jpg'
  ]
